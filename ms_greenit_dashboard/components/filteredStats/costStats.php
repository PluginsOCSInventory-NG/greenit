...
<div class="row">
    <div class="col-md-4" style="border: 1px solid #ddd; padding: 5px;">
        <p style="font-size: 32px; font-weight:bold;">' . (isset($yesterdayData["FILTERED"]) && $yesterdayData["FILTERED"]->totalConsumption != NULL ? $calculation->CostFormat($yesterdayData["FILTERED"]->totalConsumption, "W/h", $config->KILOWATT_COST, $config->COST_UNIT, $config->COST_ROUND) : '0') . '</p>
...
$diagram->createCanvas("histogram_collect_period", "6", "275");
...
$diagram->createCanvas("histogram_compare_period", "6", "275");
