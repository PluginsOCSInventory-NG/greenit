...
<div class="row">
    <div class="col-md-4" style="border: 1px solid #ddd; padding: 5px;">
        ...
        <p style="color:#333; font-size:1vw;">'.$l->g(102701).'</p>
    </div>
    <div class="col-md-4" style="border: 1px solid #ddd; padding: 5px;">
        ...
        <p style="color:#333; font-size:1vw;">'.$l->g(102702)." ".$config->COLLECT_INFO_PERIOD." ".$l->g(102705).'</p>
    </div>
    <div class="col-md-4" style="border: 1px solid #ddd; padding: 5px;">
        <p style="font-size:2vw; font-weight:bold;">'.(isset($limitedData) ? $calculation->CostFormat($sumConsumptionCompare, "W/h", $config->KILOWATT_COST, $config->COST_UNIT, $config->COST_ROUND) : '0').'</p>
        <p style="color:#333; font-size:1vw;">'.$l->g(102702)." ".$config->COMPARE_INFO_PERIOD." ".$l->g(102705).'</p>
    </div>
</div>
';
