...
<<<<<<< HEAD
    ...
    <div class="col-md-3" style="border: 1px solid #ddd;">
        <p style="font-size: 32px; font-weight:bold;">' . (isset($yesterdayData) ? $calculation->ConsumptionFormat($yesterdayData[0]->consumptionAverage, "kW/h", $config->CONSUMPTION_ROUND) : '0') . '</p>
    ...
    <div class="col-md-3" style="border: 1px solid #ddd;">
        <p style="font-size: 32px; font-weight:bold;">' . (isset($yesterdayData) ? $calculation->TimeFormat($yesterdayData[0]->uptimeAverage, $config->UPTIME_FORMAT) : '0') . '</p>
...
=======
    ...
    <div class="col-md-3" style="border: 1px solid #ddd;">
        <p style="font-size: 32px; font-weight: bold;">' . (isset($yesterdayData) ? $calculation->ConsumptionFormat($yesterdayData[0]->consumptionAverage, "kW/h", $config->CONSUMPTION_ROUND) : '0') . '</p>
        <p style="color: #333; font-size:15px;">'.$l->g(80907).'</p>
    </div>
    <div class="col-md-3" style="border: 1px solid #ddd;">
        <p style="font-size: 32px; font-weight: bold;">' . (isset($yesterdayData) ? $calculation->TimeFormat($yesterdayData[0]->totalUptime, $config->UPTIME_FORMAT) : '0') . '</p>
    ...
    <div class="col-md-3" style="border: 1px solid #ddd;">
        <p style="font-size: 32px; font-weight: bold;">' . (isset($yesterdayData) ? $calculation->TimeFormat($yesterdayData[0]->uptimeAverage, $config->UPTIME_FORMAT) : '0') . '</p>
        <p style="color: #333; font-size:15px;">'.$l->g(80909).'</p>
>>>>>>> main
    </div>
</div>
';
