...
'<div>
    <table id="tab_stats" style="font-family: \'Helvetica Neue\',Helvetica,Arial,sans-serif; text-align:center; margin:auto; width:100%; margin-top:20px; background:#fff; border: 1px solid #ddd; table-layout: fixed;" >
        <tr>
            ...
            <td style="border-right: 1px solid #ddd;"><span style="font-size:32px; font-weight:bold;">' . (isset($yesterdayData) ? $calculation->ConsumptionFormat($yesterdayData[0]->consumptionAverage, "kW/h", $config->CONSUMPTION_ROUND) : '0') . '</span> </p><span style="color:#333; font-size:13pt;">'.$l->g(80907).'</span></td>
            ...
            <td style="border-right: 1px solid #ddd;"><span style="font-size:32px; font-weight:bold;">' . (isset($yesterdayData) ? $calculation->TimeFormat($yesterdayData[0]->uptimeAverage, $config->UPTIME_FORMAT) : '0') . '</span> </p><span style="color:#333; font-size:13pt;">'.$l->g(80909).'</span></td>                 
        </tr>
    </table>
</div>';
